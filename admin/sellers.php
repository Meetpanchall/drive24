...
<div class="table-wrap" style="margin-top:14px"><table class="data">
  <thead><tr><th>#</th><th>Partner</th><th>Type</th><th>Dealership</th><th>Listings</th><th>Live</th><th>Sold</th><th>Payouts</th><th>KYC</th><th>Status</th></tr></thead>
  <tbody>
  <?php if (!$rows): ?><tr><td colspan="10" class="empty">No sellers registered.</td></tr><?php endif; ?>
