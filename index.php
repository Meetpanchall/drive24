...
<section class="hero">
  <div class="wrap">
    ...
    <div class="hero-stats">
      <div><b class="num"><?= $stats['cars'] ?>+</b><span>Certified cars live</span></div>
      <div><b class="num"><?= $stats['cities'] ?></b><span>Cities served</span></div>
      <div><b class="num"><?= $stats['sellers'] ?></b><span>Verified sellers</span></div>
      <div><b class="num"><?= $stats['orders'] ?></b><span>Cars delivered</span></div>
    </div>
...
<section class="wrap section">
  <h2>Why 2 lakh+ buyers choose DRIVE24</h2>
  <div class="grid four">
