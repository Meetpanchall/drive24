...
<div class="wrap section" style="max-width:760px">
  <div class="card card-pad" style="text-align:center">
    ...
    <div class="card card-pad" style="text-align:left;margin-top:16px">
      ...
      <div class="kv"><span>1. Documentation</span><span><a href="<?= e(base('agreement.php?order=' . (int) $order['id'])) ?>">Sign the sale agreement online</a>; we verify the RC and insurance.</span></div>
